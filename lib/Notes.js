...
// First index i where notes[i][1] >= t. `notes` must be sorted by start time
// (field 1). Lets the renderer jump straight to the on-screen slice instead of
// scanning from zero every frame.
function lowerBoundByStart(notes, t) {
